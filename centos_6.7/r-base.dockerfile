...
RUN R -e "install.packages(c('jsonlite', 'xlsx', 'ggplot2', 'plyr', 'dplyr', 'psych', 'readxl', 'xlsx', 'openxlsx', 'jsonlite', 'rjson', 'RJSONIO', 'stringr', 'pROC', 'data.table', 'Formula'), repos='http://cran.rstudio.com')"
