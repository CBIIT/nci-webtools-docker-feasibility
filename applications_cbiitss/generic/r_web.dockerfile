...
RUN R -e  "install.packages(c(\
        ...
        'https://nciws-d709-v.nci.nih.gov/cbiit-package/cbiitss/packages/JPSurv_2.0.19.tar.gz' \
        'https://nciws-d709-v.nci.nih.gov/cbiit-package/cbiitss/packages/coxph.risk_0.2.tar.gz' \
        'https://nciws-d709-v.nci.nih.gov/cbiit-package/cbiitss/packages/iCARE_1.1.0.tar.gz' \
    ), repos = 'http://cran.rstudio.com')"
